...
#define CREATOR_ATTRIBUTE_MFG_INDICATOR_STATE_SINGLETON 0xB008
#define NVM3KEY_ATTRIBUTE_MFG_INDICATOR_STATE_SINGLETON ( NVM3KEY_DOMAIN_ZIGBEE | 0xB008 )
// Creator for attribute: TimeScale, singleton.
#define CREATOR_ATTRIBUTE_MFG_TIME_SCALE_SINGLETON 0xB009
#define NVM3KEY_ATTRIBUTE_MFG_TIME_SCALE_SINGLETON ( NVM3KEY_DOMAIN_ZIGBEE | 0xB009 )
// Creator for attribute: on/off, endpoint: 2
#define CREATOR_ON_OFF_2 0xB00A
#define NVM3KEY_ON_OFF_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB00A )
// Creator for attribute: start up on off, endpoint: 2
#define CREATOR_START_UP_ON_OFF_2 0xB00B
#define NVM3KEY_START_UP_ON_OFF_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB00B )
// Creator for attribute: current level, endpoint: 2
#define CREATOR_CURRENT_LEVEL_2 0xB00C
#define NVM3KEY_CURRENT_LEVEL_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB00C )
// Creator for attribute: start up current level, endpoint: 2
#define CREATOR_START_UP_CURRENT_LEVEL_2 0xB00D
#define NVM3KEY_START_UP_CURRENT_LEVEL_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB00D )
// Creator for attribute: closed limit, endpoint: 2
#define CREATOR_SHADE_CONFIG_CLOSED_LIMIT_2 0xB00E
#define NVM3KEY_SHADE_CONFIG_CLOSED_LIMIT_2 ( NVM3KEY_DOMAIN_ZIGBEE | 0xB00E )
